...
function register($data){
    ...
    //cek apakah ada username yang sama sebelumnya
    ...
    //cek konfirmasi passwordnya apakah sama dengan password satu
    ...
    //enkripsi password agar tidak dibobol hangkerr
